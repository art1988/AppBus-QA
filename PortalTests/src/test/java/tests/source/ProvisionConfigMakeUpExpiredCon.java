...
public class ProvisionConfigMakeUpExpiredCon
{
    static final SimpleDateFormat df = new SimpleDateFormat("MM.dd.HH.mm.ss");

    @Test
    public void ProvisionConfigMakeUpExpiredCon() throws InterruptedException
    {
        ProvisionConfigMakeUpExpiredCon(true);
    }

    public void ProvisionConfigMakeUpExpiredCon(boolean refresh) throws InterruptedException
    {
...
//create Expired config (start)
        ...
        System.out.println("Going to click YESTERDAY");
        Thread.sleep(1_000);
        ...
        Thread.sleep(2_000);
        adcon.clickStartTime();
        Thread.sleep(1_000);
        adcon.clickTomorrowDayPlus1();
        Thread.sleep(1_000);
        adcon.clickOk();
        Thread.sleep(2_000);
        pc.clickApply();
        Thread.sleep(3_000);
        System.out.println("ProvisionConfigDeleteExpiredCon: Expired config can't be created by user for now");
//create Expired config (finish)
/*
        //pc.deleteExpiredConfig();
