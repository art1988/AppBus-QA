...
public class ProvisionConfigUploadUpcomingSave
{
    static final SimpleDateFormat df = new SimpleDateFormat("MM.dd.HH.mm.ss");

    @Test
    public void ProvisionConfigUploadUpcomingSave() throws InterruptedException
    {
        ProvisionConfigUploadUpcomingSave(true);
    }

    public void ProvisionConfigUploadUpcomingSave(boolean refresh) throws InterruptedException
    {
...
//delete Upcoming config if exists (start)
        ...
        System.out.println("ProvisionConfigUploadUpcomingSave: noProblems = " + noProblems);
...
//Check uploaded config (finish)
        ...
        pc.clickApply();
        Thread.sleep(5_000);
        //if(pc.isErrorPanelVisible()) pc.deleteExpiredConfig();
        //Thread.sleep(2_000);
