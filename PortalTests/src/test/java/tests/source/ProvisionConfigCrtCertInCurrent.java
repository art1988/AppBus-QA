...
public class ProvisionConfigCrtCertInCurrent
{
    ...
    @Test
    public void ProvisionConfigCrtCertInCurrent() throws InterruptedException
    {
        ProvisionConfigCrtCertInCurrent(true);
    }

    public void ProvisionConfigCrtCertInCurrent(boolean refresh) throws InterruptedException
    {
        ...
        String cPass = "uniq99Pass@##$#";
        String cName = "crtAutoName99" + tmpstp;
        String cType = "p12";
...
//stop script if Current config doesn't exist (start)
        ...
        System.out.println("ProvisionConfigCrtCertInCurrent: noProblems = " + noProblems);
        ...
        Assert.assertTrue("ProvisionConfigCrtCertInCurrent: create please Current config if one doesn't exist", ItemLIst.contains("Current config"));
//stop script if Current config doesn't exist (finish)

        System.out.println("ProvisionConfigCrtCertInCurrent: going to select Current config");
...
//Check Current config before (finish)
        ...
        Assert.assertTrue("ProvisionConfigCrtCertInCurrent: Data uploaded mark changed to Ok (true/false):", cd.ifUploadedIcon());
        ...
        Assert.assertTrue("ProvisionConfigCrtCertInCurrent: Verify Certificate fields content :", success);
        Thread.sleep(1_000);
        pc.clickApply();
        Thread.sleep(2_000);
...
//Check Current config after (finish)
        ...
        Assert.assertTrue("ProvisionConfigCrtCertInCurrent: Gateways table is the same:",table2after.equals(table2sourse));

        Assert.assertTrue("ProvisionConfigCrtCertInCurrent: Services table is the same:",table3after.equals(table3sourse));
