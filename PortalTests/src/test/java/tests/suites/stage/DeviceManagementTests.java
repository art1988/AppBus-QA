...
//Vitaly's tests:
        ...
        ProvisionConfigCreateCertAndGateways.class, //C18028 (was C2747) case on testrail //ED-4146
        ProvisionConfigCrCertGatewayService.class, //C18029 (was C2748) case on testrail //ED-4146
        ProvisionConfigApplyConfig.class, //C18030 + C18031 (was C2749 + C2750) case on testrail //ED-4146
...
//ED-4146        ProvisionConfigSaveUpcoming.class, //C18093 (was C2752) + C18151 (was C2767) case on testrail //ED-4146
        ...
        ProvisionConfigDeleteExpiredCon.class, //C20192 (was C2929) case on testrail  //ED-4196 //todo: add check parms after ED-4213 fix
        RenewConfigsViaUploadingNewBoth.class, //for precondition of further cases
        ProvisionConfigMakeUpExpiredCon.class, //C20190 (was C2928) case on testrail // expired config can't be created by user now //todo: add check parms after ED-4213 fix
        ...
        ProvisionConfigCrtCertAndGatInC.class, //C25045 (was C3092) case on testrail
        ProvisionConfigCrtAllThingInCur.class, //C25046 (was C3093) case on testrail
})

public class DeviceManagementTests extends ChromeWindowedExternalStageSetup
{
