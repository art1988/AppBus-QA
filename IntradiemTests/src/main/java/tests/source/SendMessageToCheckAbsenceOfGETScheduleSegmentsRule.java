...
public class SendMessageToCheckAbsenceOfGETScheduleSegmentsRule
{
    @Test
    public void sendMessageToCheckAbsenceOfGETScheduleSegmentsRule()
    {
        Saver.addDesiredMessageInFIFO("NoGETScheduleSegments");
