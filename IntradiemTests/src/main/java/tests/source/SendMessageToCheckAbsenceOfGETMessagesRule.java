...
public class SendMessageToCheckAbsenceOfGETMessagesRule
{
    @Test
    public void sendMessageToCheckAbsenceOfGETMessagesRule()
    {
        Saver.addDesiredMessageInFIFO("NoGETMessages");
