...
# @unittest.skip('Ok')
class Test8AllEvents1(unittest.TestCase):
    def setUp(self):
        pass
    ...
    # @unittest.skip('Ok')
    def test1_all_events(self):
        mgd.find_element_by_class_name(cal.all_event_button).click()
        if len(mgd.find_elements_by_id(cal.all_appointments_panel)) != 1:
            raise Exception('All appointments panel is missing')
        Check.find_element_by_class_name_and_text(cal.button, 'All Events').click()
        time.sleep(1)
        if len(mgd.find_elements_by_id(cal.all_appointments_panel)) == 1:
            raise Exception('All appointments panel not closed')

    # @unittest.skip('Ok')
    def test2_all_events(self):
        mgd.find_element_by_class_name(cal.all_event_button).click()
        if len(mgd.find_elements_by_id(cal.all_appointments_panel)) != 1:
            raise Exception('All appointments panel is missing')
        actions = ActionChains(driver_instance)
...
class Test8AllEvents2(unittest.TestCase):
    def setUp(self):
        pass
    ...
    def test1_all_events(self):
        ...
        value = 0
        while value <= 2:
            location_name = 'Loc_all_day_' + str(value + 1)
    ...
    # @unittest.skip('Ok')
    def test2_all_events_show_in_grid(self):
        mgd.find_element_by_class_name(cal.all_event_button).click()
        time.sleep(1)
        if len(mgd.find_elements_by_id(cal.all_appointments_panel)) != 1:
            raise Exception('All appointments panel is missing')
        ...
        location_name = 'Loc_all_day_' + str(2)
        print('location_name', location_name)
        elem = list_of_elem[1]
        elem.click()
        time.sleep(1)
        ...
        Check.find_element_by_id_and_text(cal.tooltip_panel_button, 'Show in the grid').click()
    ...
    # @unittest.skip('Not Ok')
    def test3_all_events_show_in_grid(self):
        mgd.find_element_by_class_name(cal.all_event_button).click()
        time.sleep(1)
        if len(mgd.find_elements_by_id(cal.all_appointments_panel)) != 1:
            raise Exception('All appointments panel is missing')
        ...
        location_name = 'Loc_all_day_' + str(4)
        print('location_name', location_name)
        elem = list_of_elem[3]
        elem.click()
        time.sleep(1)
