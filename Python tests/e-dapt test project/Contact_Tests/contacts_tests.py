...
def setUpModule():
    ...
    if Check.check_exists_by_class_name(cm.contacts_folders_list):
        print('View mode is list of folders')
    else:
        print('View mode is list of contacts')
        mgd.find_element_by_class_name(cm.view_change_button).click()
    ...
    if cm.folder_select not in folder_status:
        raise Exception(contacts_folder + ' folder in not selected')
    elif cm.folder_select in folder_status:
...
def tearDownModule():
    ...
    if cm.folder_select not in folder_status:
        ...
        print('Check - ' + contacts_folder + ' folder is selected')
    names_for_delete = ['abr.test', 'Allison', 'A Eddie Dean', 'Chambers Jake', 'A Test', 'Armitage', 'BBC_edit']
    for del_name in names_for_delete:
        if Check.find_element_by_class_name_and_text(cm.contact_title, del_name):
            Check.find_element_by_class_name_and_text(cm.contact_title, del_name).click()
            mgd.find_element_by_id(cm.delete_option).click()
    ...
    if Check.check_exists_by_class_name(cm.contacts_folders_list):
        ...
        main_len_of_list = len(mgd.find_elements_by_class_name(cm.contact_name_in_abc))
        ...
        while main_len_of_list >= 2:
            ...
            print('Check - Delete button')
            time.sleep(1)
            new_list = len(mgd.find_elements_by_class_name(cm.contact_name_in_abc))
...
class Test1(unittest.TestCase):
    ...
    def setUp(self):
        mgd.find_element_by_class_name(cm.add_contact_button).click()
    ...
    def tearDown(self):
        ...
        if Check.check_exists_by_class_name(cm.apply_unsaved_changes):
            ...
            Check.find_element_by_class_name_and_text(cm.confirm_button, 'No').click()

        if mgd.find_elements_by_class_name(cm.close_editor_confirmation):
            # actions = ActionChains(driver_instance)
            element = mgd.find_element_by_class_name(cm.block_wrapper)
    ...
    def test_2_save_option(self):
        ...
        Check.assert_equal_id(self, cm.save_option, 1, 'Yes options unavailable', 'Check - Yes options')
        Check.assert_in_id_class(
            self, cm.save_option, 'clickable', 'Yes options not clickable', 'Check - Yes options is clickable :')
        mgd.find_element_by_id(cm.save_option).click()
        time.sleep(3)
        mgd.find_element_by_xpath("//*[@class='contact-card__title' and contains(text(),'"+name+"')]")
...
class Test1Folders(unittest.TestCase):
    ...
    def test1_folders(self):
        mgd.find_element_by_class_name(cm.contacts_folders_list)
...
class Test2Options(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if mgd.find_elements_by_class_name(cm.close_editor_confirmation):
            # actions = ActionChains(driver_instance)
            element = mgd.find_element_by_id(cm.close_editor_confirmation)
            actions.move_to_element(element).move_by_offset(-450, -500).click().perform()
        if Check.check_exists_by_xpath(cm.contact_modal_window):
            print('Contact card - exist')
            mgd.find_element_by_id(cm.close_button).click()
        if Check.check_exists_by_class_name(cm.apply_unsaved_changes):
    ...
    # @unittest.skip("Ok")
    def test1_for_save_option(self):
        name = "Armitage"
        name2 = 'AAAppolo'
        repeat = 1
        while repeat < 2:
            ...
            Check.assert_in_id_value(
                self, cm.name_input, name, 'Name input contain wrong data', 'Check - Name input contain ')
            Check.assert_in_class_name_text(
                self, cm.contact_title, name, 'Name title contain wrong data', 'Check - Name title contain ')
            Check.assert_equal_id(self, cm.save_option, 1, 'Yes options unavailable', 'Check - Yes options')
            Check.assert_in_id_class(
                self, cm.save_option, 'clickable', 'Yes options not clickable', 'Check - Yes options is clickable :')
            mgd.find_element_by_id(cm.save_option).click()
            ...
            if Check.find_element_by_class_name_and_text(cm.contact_title, name):
                ...
                raise Exception(name + ' contact card - Not found')
            time.sleep(1)
            repeat += 1
    ...
    def test_for_undo_option_create(self):
        ...
        Check.assert_in_xpath_text(
            self, cm.job_title_info, job_title, 'Job title contain wrong data', 'Check - Job title contain ')
        time.sleep(1)
        Check.assert_not_in_id_class(
            self, cm.undo_option, 'clickable', 'Undo options is clickable', 'Check - Undo options not clickable :')
        time.sleep(1)
    ...
    def test2_for_undo_option_exist(self):
        ...
        mgd.find_element_by_id(cm.undo_option).click()
        time.sleep(1)
        Check.assert_in_id_value(
    ...
    def test_for_delete_option(self):
        ...
        print('Check - Contact ' + name + ' is open')
        time.sleep(1)
        Check.assert_equal_id(self, cm.delete_option, 1, 'Delete options unavailable', 'Check - Delete options')
        Check.assert_in_id_class(
    ...
    def test_for_move_to4_with_apply_unsaved_changes_no(self):
        ...
        if not Check.find_element_by_class_name_and_text(cm.contact_title, name):
            time.sleep(2)
        Check.find_element_by_class_name_and_text(cm.contact_title, name).click()
        print('Check - Contact card')
        mgd.find_element_by_class_name(cm.contact_info)
...
class Test3EditContact(unittest.TestCase):
        def setUp(self):
            ...
            Check.assert_equal_id(self, cm.save_option, 1, 'Yes options unavailable', 'Check - Yes options')
            Check.assert_in_id_class(
                self, cm.save_option, cm.yes_option_active, 'Yes options not clickable',
...
class Test6ABCApplyUnsavedChanges(unittest.TestCase):
    def setUp(self):
        ...
        if Check.check_exists_by_class_name(cm.contacts_folders_list):
            print('View mode is list of folders')
            Check.assert_equal_class_name(
                self, cm.view_change_button, 1, 'View change button not found', 'Check - View change button')
            Check.assert_in_class_name_class(
                self, cm.view_change_button, 'clickable', 'View change button not clickable',
    ...
    def test_abc_no_wrapper(self):
        name = 'Allison'
        name2 = 'abr.test'
        allison_found = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name)
        allison_found.click()
        ...
        abrtest_found = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2)
        abrtest_found.click()
        Check.assert_equal_class_name(
        ...
        if not Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2):
            raise Exception('Contact name missing')
    ...
    def test_abc_yes_wrapper(self):
        ...
        if not Check.find_element_by_class_name_and_text(cm.contact_title, name2):
            raise Exception('Contact name missing')
        print('Check - Contact name is ' + name2)
        allison_found.click()
        print('Check - ' + name + ' contact card is found')
...
class Test7ABCOptions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        print(Check.check_exists_by_class_name(cm.contacts_folders_list))
        if Check.check_exists_by_class_name(cm.contacts_folders_list):
            print('View mode is list of folders')
            Check.assert_equal_class_name(
                self, cm.view_change_button, 1, 'View change button not found', 'Check - View change button')
        ...
        time.sleep(2)
        name2 = "BBC_edit"
        abc_found = Check.find_element_by_class_name_and_text(cm.contact_title, name2)
        if not abc_found:
            mgd.find_element_by_class_name(cm.add_contact_button).click()
            mgd.find_element_by_id(cm.name_input).send_keys(name2)
            mgd.find_element_by_id(cm.save_option).click()
    ...
    def test_for_delete_options_in_abc_view(self):
        ...
        abc_found = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2)
        abc_found.click()
        ...
        print('Check - Delete button')
        time.sleep(2)
        if mgd.find_elements_by_class_name(cm.block_wrapper):
            raise Exception('Delete wrapper exist')
    ...
    def test_for_undo_options_in_abc_view(self):
        ...
        abc_found.click()
        Check.assert_equal_class_name(self, cm.contact_info, 1, 'Contact info does not exist', 'Check - Contact info')
        Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2)
        time.sleep(1)
        job_title = 'undo'
        mgd.find_element_by_id(cm.job_title_input).send_keys(job_title)
        time.sleep(1)
    ...
    def test_for_save_options_in_abc_view(self):
        time.sleep(2)
        name2 = 'BBC_edit'
        abc_found = Check.find_element_by_class_name_and_text(cm.contact_title, name2)
        abc_found.click()
...
class Test8ABCFill(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if Check.check_exists_by_class_name(cm.apply_unsaved_changes):
            print('Block wrapper "Apply unsaved changes" - exist')
            Check.find_element_by_class_name_and_text(cm.confirm_button, 'No').click()
        if Check.find_element_by_class_name_and_text(cm.contact_title, name2):
            Check.find_element_by_class_name_and_text(cm.contact_title, name2).click()
            mgd.find_element_by_id(cm.delete_option).click()
            Check.element_is_visible_class_name(
                cm.block_wrapper, 'Check - Delete wrapper', 'Delete wrapper does not exist')
            time.sleep(2)
    ...
    def test_fill_and_yes_abc_view(self):
        ...
        bbc_edit_found = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2)
        ...
        mgd.find_element_by_id(cm.save_option).click()
        time.sleep(1)
        Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name).click()
...
class Test9ABCSearch(unittest.TestCase):
    ...
    def test_search_name(self):
        ...
        time.sleep(3)
        Check.check_exists_contacts_by_class_name(
            cm.contact_name_in_abc, 14, 'Contacts list contains more elements',
            'Contacts list contains less elements', 'Contacts list contains the right amount elements')
    ...
    def test_search_company(self):
        ...
        time.sleep(3)
        Check.check_exists_contacts_by_class_name(
            cm.contact_name_in_abc, 8, 'Contacts list contains more elements',
            'Contacts list contains less elements', 'Contacts list contains the right amount elements')
    ...
    def test_search_department(self):
        ...
        time.sleep(3)
        Check.check_exists_contacts_by_class_name(
            cm.contact_name_in_abc, 3, 'Contacts list contains more elements',
            'Contacts list contains less elements', 'Contacts list contains the right amount elements')
    ...
    def test_search_work_phone(self):
        ...
        time.sleep(3)
        Check.check_exists_contacts_by_class_name(
            cm.contact_name_in_abc, 5, 'Contacts list contains more elements',
            'Contacts list contains less elements', 'Contacts list contains the right amount elements')
    ...
    def test_deleted_items_ABC(self):
        if Check.check_exists_by_class_name(cm.contacts_folders_list):
            ...
            while main_len_of_list >= 2:
                name = mgd.find_element_by_class_name(cm.contact_title).get_attribute('innerText')
                print('Check - Contact ' + name + ' is open')
                Check.assert_equal_id(self, cm.delete_option, 1, 'Delete options unavailable',
...
class Test11ABCSelectContacts(unittest.TestCase):
    ...
    def test_select_contacts(self):
        ...
        contact1 = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name1)
        # actionsChains.move_to_element(contact1)
        # actionsChains.perform()
        contact1.click()

        Check.assert_in_class_name_text(
            self, cm.name_title, name1, 'Contact is not a ' + name1, 'Check - contact ' + name1)
        time.sleep(2)
        contact2 = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name2)
        # actionsChains.move_to_element(contact2)
        # actionsChains.perform()
        contact2.click()

        Check.assert_in_class_name_text(
            self, cm.name_title, name2, 'Contact is not a ' + name2, 'Check - contact ' + name2)
        time.sleep(2)
        contact3 = Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name3)
        # actionsChains.move_to_element(contact3).perform()
        contact3.click()
        Check.assert_in_class_name_text(
            self, cm.name_title, name3, 'Contact is not a ' + name3, 'Check - contact ' + name3)
        time.sleep(2)
        Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name4).click()
        Check.assert_in_class_name_text(
            self, cm.name_title, name4, 'Contact is not a ' + name4, 'Check - contact ' + name4)
        time.sleep(2)
        Check.find_element_by_class_name_and_text(cm.contact_name_in_abc, name5).click()
        Check.assert_in_class_name_text(
            self, cm.name_title, name5, 'Contact is not a ' + name5, 'Check - contact ' + name5)
        time.sleep(2)
